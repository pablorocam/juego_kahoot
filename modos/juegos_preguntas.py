...
def main():
    ...
    if not st.session_state.respuestas_ordenadas:
        st.session_state.respuestas_ordenadas = [pregunta_actual['Correcta'],
    ...
    if st.session_state.indice >= len(st.session_state.preguntas):
        ...
        if st.button("🔁 Reiniciar juego"):
            for key in ['preguntas', 'indice', 'correctas', 'incorrectas', 'respondido', 'correcta_actual', 'fue_correcto', 'respuestas_ordenadas', 'tema_actual']:
